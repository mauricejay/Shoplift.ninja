    ...
    <?php include 'core/includes/head.php' ?>
        ...
        <body>
            <?php include 'header.php' ?>
                ...
                <div class="row container">
                    ...
                    <div class="row">
                        <div class="col s12 m4">
                            <div class="card medium  animated fadeIn">
                ...
                <section class="container center animated fadeIn">
                    <div class="card lighten-4 white-text">
                        <h1 class="black-text">About us</h1>
                        <h5 class="black-text">If you are looking to resell your phones, books, or laptops! Shop.ninja is a site for you, <a href="./signup.php.html" style="color:#8a8add;">make an account</a> and post a phone!</h5>
                    </div>
                </section>
